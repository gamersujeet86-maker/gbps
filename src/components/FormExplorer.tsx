        ...
        {selectedInquiry && (
          <div className="fixed inset-0 z-50 overflow-y-auto bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-slate-950 text-white rounded-3xl border border-slate-800 shadow-2xl w-full max-w-xl p-6 sm:p-8 overflow-hidden relative"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-xs font-mono font-bold text-amber-500 bg-amber-500/10 border border-amber-500/20 px-2.5 py-0.5 rounded">
                      Reference ID: {selectedInquiry.id}
                    </span>
                    <h4 className="text-xl font-display font-extrabold text-white mt-1.5">
                      {selectedInquiry.studentName}
                    </h4>
                    <p className="text-xs text-slate-400 mt-0.5">Applied Class: <strong className="text-amber-400">{selectedInquiry.className}</strong></p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-slate-900">
                  ...
                  <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-3.5 space-y-1">
                    ...
                    <div className="flex items-center gap-2 text-slate-200 text-xs font-semibold">
                      ...
                      <span>{selectedInquiry.parentName}</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-3.5 space-y-1">
                    ...
                    <div className="flex items-center gap-2 text-slate-200 text-xs font-semibold">
                      ...
                      <span>{selectedInquiry.className} Grade Standard</span>
                    </div>
                  </div>
                ...
                <div className="bg-slate-900/60 border border-slate-800/80 rounded-xl p-4 space-y-1.5">
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed bg-slate-950/40 p-3 rounded-lg border border-slate-800/50">
                    {selectedInquiry.message || "No custom remarks specified by parent."}
                  </p>
                </div>
                ...
                <div className="bg-amber-500/5 border border-amber-500/10 rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-slate-200">{selectedInquiry.submittedAt}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-emerald-400 bg-emerald-500/10 px-3 py-1.5 rounded-xl border border-emerald-500/20 font-bold">
                ...
                <button
                  ...
                  className="w-full py-3 bg-slate-800 hover:bg-slate-750 border border-slate-700 text-slate-200 hover:text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2"
                >
